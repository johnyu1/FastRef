...
public class DocumentTest {
	...
	public void setUp() throws Exception {
		...
		document = new Document(user, "Name.pdf", "NewName", "docKey",
				"private");
	}
	...
	/**
	 * Creates display name with a file name that has a single extension and
	 * verifies correct display name created
	 */
	@Test
	...
	/**
	 * Creates display name with a file name that has a no extension and
	 * verifies correct display name created
	 */
	@Test
	...
	/**
	 * Creates display name with a file name that has a multiple extensions and
	 * verifies correct display name created
	 */
	@Test
	...
	/**
	 * Creates display name with a file name that has a wrong extension and
	 * verifies correct display name created
	 */
	@Test
	...
	/**
	 * Parses a file name that has a extension and verifies correct extension is
	 * parsed.
	 */
	@Test
	...
	/**
	 * Determines a file type from a given valid extension and verifies correct
	 * type is returned.
	 */
	@Test
	...
	/**
	 * Determines a file type from a given unknown extension and verifies "file"
	 * type is returned.
	 */
	@Test
	...
	/**
	 * Creates a new document and compare it to the original document. Verify
	 * that new document is "less than" the original document as it is
	 * alphabetized higher.
	 */
	@Test
	...
	/**
	 * Creates a new document and compare it to the original document. Verify
	 * that new document is "greater than" the original document as it was
	 * created later.
	 */
	@Test
	public void testCompareToSameName() {
		try {
			...
			Document newDoc = new Document(user, "Name.pdf", "NewName",
					"docKey", "private");
			assertEquals(1, determineSignOfNumber(newDoc.compareTo(document)));
